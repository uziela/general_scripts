...
my_plot_dense <- function(var1, var2, my_file, my_xlab, my_ylab, my_xlim=NULL, my_ylim=NULL, smooth=F, red_points=NULL, maint=NULL, MY_CEX=1, xaxis=FALSE, yaxis=FALSE) {
