...
my_plot_dense <- function(var1, var2, my_file, my_xlab, my_ylab, my_xlim=NULL, my_ylim=NULL, smooth=F, red_points=NULL, maint=NULL, MY_CEX=1) {
    ...
    plot(var1, var2, col=colors, xlab=my_xlab, ylab=my_ylab, xlim=my_xlim, ylim=my_ylim, cex.axis=MY_CEX, cex.lab=MY_CEX, xaxt='n', yaxt='n', main=maint, cex.main=MY_CEX, font.main = 1)
